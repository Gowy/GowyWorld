...
public class ActivityB extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		statutAff = (TextView) findViewById(R.id.editTextB);
		statutClass = new StatutActivity();
		String tmpStatut = ""+this;
		typeStatut = "B("+(tmpStatut.split("@")[1])+")";
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_activityb, menu);
		return true;
	}
	...
	public void startActivityA(View v) {
		statutClass.AddInfo(typeStatut, "startActivityA");
	...
	public void stopActivityB(View v) {
		statutClass.AddInfo(typeStatut, "stopActivityB");
		statutClass.ShowInfo(statutAff);
		this.finish();
	}
